  // mQuat.cpp: implementation of the mQuat class.
//
//////////////////////////////////////////////////////////////////////
...
void mQuat::normalize()
{
	static real one = (real)1.0; 
	static real zero = (real)0.0; 
	static real thresh = (real)0.00001;
	real mag;
...
{ 
	...
	if ((one+cosom) > epsilon) { 
		if ((one-cosom) > epsilon) { 
			...
			sclp = (real)(sin((one-t)*omega) / sinom); 
